...
export const LuxuryGallery: React.FC = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
          ...
          gsap.fromTo(
            ...
            },
            {
              ...
              scrollTrigger: {
                ...
                start: 'bottom 85%', // start animating when row bottom reaches viewport bottom
                end: 'bottom center', // complete by the time it’s halfway through
                scrub: 1.5,
      ...
      animateRow(row1Ref as React.RefObject<HTMLDivElement>, 0)
      animateRow(row2Ref as React.RefObject<HTMLDivElement>, 1.5)
      animateRow(row3Ref as React.RefObject<HTMLDivElement>, 2.0)
    }, sectionRef)
  ...
  const images: ImageData[] = [
    {
      src: 'https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=700&h=400&fit=crop',
      alt: 'Collection 1',
    },
    {
      src: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=700&h=400&fit=crop',
      alt: 'Collection 2',
    },
    {
    ...
    {
      src: 'https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=700&h=400&fit=crop',
      alt: 'Collection 4',
    },
    {
      src: 'https://images.unsplash.com/photo-1487222477894-8943e31ef7b2?w=700&h=400&fit=crop',
      alt: 'Collection 5',
    },
  ]
        ...
        >
          ...
          >
            <GalleryImage
              src={images[0].src}
              alt={images[0].alt}
              className="w-full md:w-[590px] h-[350px]"
            />
            <GalleryImage
              src={images[1].src}
              alt={images[1].alt}
